...
/**
 * Service class for managing books in the admin dashboard.
 * Handles database operations for retrieving, updating, and deleting books.
 * 
 * @author Noble Nepal
 */
public class AdminBookService {
     ...
     * 
     * @return List of BookModel objects representing books, or null if an error occurs.
     */
    public List<BookModel> getAllBooks() {
        ...
        String query = "SELECT bookID, book_title, isbn, publication_date, price, description, " +
                       "stock_quantity, page_count, book_img_url, publisherID " +
                       "FROM book";
    ...
    /**
     * Updates the stock quantity of a book by its ID and fetches the updated list of books.
     * 
     ...
     * @throws SQLIntegrityConstraintViolationException if the book is referenced in other tables (e.g., cart_item).
     */
    public List<BookModel> deleteBookById(int bookId) throws SQLException {
        ...
        try (
            ...
            if (e.getSQLState().equals("23000")) { // SQL state for foreign key constraint violation
                throw new SQLException("Cannot delete book because it is referenced in another table.", e);
            }
