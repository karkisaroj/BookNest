...
<body>
      ...
      if (searchInput.value.trim().length > 2) {
        const sampleBooks = [
          { 
            ...
            price: '12.99',
            bookImgUrl: '${pageContext.request.contextPath}/resources/images/system/placeholder.png'
          },
          { 
            bookID: 2,
        ...
        const filteredBooks = sampleBooks.filter(book => 
          book.bookTitle.toLowerCase().includes(searchInput.value.toLowerCase())
        );
    ...
    function displaySearchResults(books) {
      ...
      if (books.length > 0) {
        ...
        searchResultsPreview.classList.add('active');
        previewItemsContainer.innerHTML = '<p>No results found.</p>';
      }
    }
    </script>
</body>
